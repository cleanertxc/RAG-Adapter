...
The GCL retriever checkpoints distributed through Google Drive derive from [OpenAI CLIP ViT-L/14](https://github.com/openai/CLIP) and [BAAI/bge-m3](https://huggingface.co/BAAI/bge-m3). Their upstream MIT license notices are included as `third_party/CLIP-MIT.txt` and `third_party/FlagEmbedding-MIT.txt`. The BGE-M3 model card identifies its license as MIT and refers to FlagEmbedding for the project implementation.
